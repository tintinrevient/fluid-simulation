class Simulator {
    ...
    reset(particlesWidth, particlesHeight, particlePositions, gridSize, gridResolution, particleDensity, flipness) {
        ...
        //generate initial particle positions and create particle position texture for them
